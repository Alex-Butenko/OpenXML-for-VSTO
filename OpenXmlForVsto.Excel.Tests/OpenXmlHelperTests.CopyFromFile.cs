...
namespace OpenXmlForVsto.Excel.Tests {
    ...
    public partial class OpenXmlHelperTests {
        ...
        [Test]
        public void CopyFromFile_Test_CopiesProvidedSheet() {
            ...
            new OpenXmlHelper().CopyFromFile(_tmpFile, range, sheetName);
        ...
        [Test]
        public void CopyFromFile_Test_CopiesCorrectPosition() {
            const int expected1 = 1;
            ...
            new OpenXmlHelper().CopyFromFile(_tmpFile, range);
        ...
        [Test]
        public void CopyFromFile_Test_CopiesCorrectFormulas() {
            _tmpFile = GetNewRandomFilePath(GetOrCreateTmpDirectory());
            using (XLWorkbook workbook = new XLWorkbook()) {
                IXLWorksheet sourceSheet = workbook.Worksheets.Add();
        ...
        [Test]
        public void CopyFromFile_Test_CopiesCorrectFormulas_WithMissingSource() {
            _tmpFile = GetNewRandomFilePath(GetOrCreateTmpDirectory());
            using (XLWorkbook workbook = new XLWorkbook()) {
                IXLWorksheet sourceSheet = workbook.Worksheets.Add();
